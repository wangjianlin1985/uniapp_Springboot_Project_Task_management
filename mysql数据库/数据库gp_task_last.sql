/*
 ...
 Source Schema         : gp_task

 Target Server Type    : MySQL
 Target Server Version : 50620
 File Encoding         : 65001

 Date: 22/05/2021 14:41:41
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 119 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_config` VALUES (101, '系统名称', 'sys.name', '任务管理系统', 'Y', 'admin', '2019-08-07 00:04:04', 'admin', '2021-05-22 14:32:19', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (102, '系统版权', 'sys.copyright', '欢迎使用任务管理系统', 'Y', 'admin', '2019-08-07 00:26:47', 'admin', '2021-05-22 14:32:17', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (103, 'LOGO图片', 'sys.logo', '/profile/logo/2021/05/22/80cd7cb527db8096d1e2f033f6f63719.png', 'Y', 'admin', '2019-08-08 00:03:03', 'admin', '2021-05-22 14:32:08', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (118, '移动端登录背景', 'app_login_bg', '/profile/logo/2021/05/22/905dec2215dbb529473b2d63747bb7c0.jpg', 'Y', 'admin', '2021-05-21 21:48:11', 'admin', '2021-05-22 14:32:25', NULL, 0, NULL, NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 1935 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2433 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_menu` VALUES (2423, '任务管理', 0, 50, '#', 2, 'menuItem', 'M', '0', NULL, 'fa fa-calendar', 'admin', '2021-05-18 14:10:10', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2424, '模版管理', 2423, 100, '/task/projecttemp', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-18 14:10:39', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2425, '项目管理', 2423, 120, '/task/project', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-18 16:27:58', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2426, '项目回收站', 2423, 110, '/task/project/huishouIndex', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-18 16:28:38', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2427, '邀请列表', 2423, 115, '/task/projectuser/todoIndex', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-18 21:06:48', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2428, '标签管理', 2423, 90, '/task/label', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-18 21:49:03', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2429, '我的任务', 2423, 130, '/task/task/taskUser', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-19 14:35:50', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2430, '任务列表', 2423, 128, '/task/task/taskDuty', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-19 14:36:27', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2431, '全部任务', 2423, 126, '/task/task/taskAdmin', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-19 14:36:48', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2432, '数据分析', 2423, 80, '/task/chart/index', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2021-05-21 17:22:46', '', NULL, '', NULL, NULL, 0);
...
INSERT INTO `sys_menu_top` VALUES (2, '任务管理', 100, '', 'fa fa-bar-chart', 'admin', '2021-04-13 21:05:38', 'admin', '2021-05-21 21:40:43', '', NULL, NULL, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 301 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 117 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '1', '0', 0, 'admin', '2018-03-16 11:33:00', 'admin', '2020-11-05 14:37:13', '管理员', NULL, NULL);
INSERT INTO `sys_role` VALUES (116, '普通用户', 'ys', 10, '1', '0', 0, 'admin', '2021-05-01 23:18:25', 'admin', '2021-05-21 17:22:54', '', NULL, NULL);
...
-- ----------------------------
INSERT INTO `sys_role_menu` VALUES (116, 2423);
INSERT INTO `sys_role_menu` VALUES (116, 2424);
INSERT INTO `sys_role_menu` VALUES (116, 2425);
INSERT INTO `sys_role_menu` VALUES (116, 2426);
INSERT INTO `sys_role_menu` VALUES (116, 2427);
INSERT INTO `sys_role_menu` VALUES (116, 2428);
INSERT INTO `sys_role_menu` VALUES (116, 2429);
INSERT INTO `sys_role_menu` VALUES (116, 2430);
INSERT INTO `sys_role_menu` VALUES (116, 2432);
...
) ENGINE = InnoDB AUTO_INCREMENT = 12717 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '超级管理员', '0001', '0001', '', '', '1', '/profile/avatar/2021/04/13/67c927e23312edd1164b8906c1a69e60.png', '074f702fddb7679c5390d5edb1456dca', 'c085a6', '0', 0, '', '2021-04-21 23:43:50', '127.0.0.1', '2021-05-22 14:31:50', '管理员', 'admin', '2021-05-01 23:23:12', 'admin', '2021-05-22 14:31:49', NULL, NULL, 0, 'yZtq77VQjcHPOkQk8IxJzg==');
INSERT INTO `sys_user` VALUES (12711, 213, 'ys1', '伊升', NULL, NULL, '13454545rr@qq.com', '13865454545', '2', '', '09af46f284638c2fddf4cb0653f76f1e', '03cda6', '0', 0, NULL, '2021-05-01 23:23:12', '127.0.0.1', '2021-05-21 22:52:58', '', 'admin', '2021-05-01 23:23:12', 'admin', '2021-05-21 22:52:56', NULL, NULL, 0, 'LQVts40KUDWknT7lbhYLIjZowy9vL3Y62MKr5UiIGHFiDrIGx0X4qkmKzrBcfuNR');
INSERT INTO `sys_user` VALUES (12714, 213, 'ys2', '用户2', NULL, NULL, '', '', '2', '', 'becfac37dd1986dc800991a98653d856', 'a8a290', '0', 0, NULL, '2021-05-18 16:31:30', '127.0.0.1', '2021-05-21 22:52:42', NULL, 'admin', '2021-05-18 16:31:30', '', '2021-05-21 22:52:41', NULL, NULL, 0, 'JyvSZLYVNEAHnmo1HG4SGMO5xRK599skDw3thm+WizliDrIGx0X4qkmKzrBcfuNR');
INSERT INTO `sys_user` VALUES (12715, 213, 'ys3', '用户3', NULL, NULL, '', '', '0', '', '8ac0a782f1bd7bc7fde0865e58fac237', '20ec96', '0', 1, NULL, '2021-05-19 21:46:35', '127.0.0.1', '2021-05-19 21:46:45', NULL, '', '2021-05-19 21:46:35', '', '2021-05-19 21:46:45', NULL, NULL, 0, 'I8I9UFYqUvw+G6L1Bm/XukNF2tt59uoFijeWzPzLQYpiDrIGx0X4qkmKzrBcfuNR');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('0556ef00-a3c0-47ec-b7eb-017023573b72', 'ys1', '伊升', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-20 11:45:23', '2021-05-20 11:58:20', 604800000);
INSERT INTO `sys_user_online` VALUES ('41bee51f-7082-41cf-ba45-59e7fbd4c135', 'ys1', '伊升', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-05-19 22:12:50', '2021-05-19 22:12:57', 604800000);
INSERT INTO `sys_user_online` VALUES ('4efec55d-7d1f-4094-9551-8c1569dcf97f', 'admin', '超级管理员', '0001', '0001', 0, '', 'XX部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-05-21 23:08:28', '2021-05-21 23:08:36', 604800000);
INSERT INTO `sys_user_online` VALUES ('4f7310dc-edaa-41a4-8e2f-dfef81af8e41', 'ys1', '伊升', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-19 15:30:13', '2021-05-19 17:56:16', 604800000);
INSERT INTO `sys_user_online` VALUES ('59b32d77-bf80-4fc6-96c9-9a3f5b4d2dd4', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', 'XX部门', '127.0.0.1', '内网IP', 'Chrome Mobile', 'Android 6.x', 'on_line', '2021-05-20 15:13:00', '2021-05-20 15:13:09', 604800000);
INSERT INTO `sys_user_online` VALUES ('7edb458e-47e7-45c5-8d9b-dd41d0634c4c', 'ys1', '伊升23', NULL, NULL, 0, '1386565656', '内部', '192.168.1.122', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-21 14:56:05', '2021-05-21 14:56:05', 604800000);
INSERT INTO `sys_user_online` VALUES ('9ea802a0-e7bd-46bb-9e14-208a208c3580', 'ys1', '伊升23', NULL, NULL, 0, '1386565656', '内部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-21 17:23:08', '2021-05-21 17:35:30', 604800000);
INSERT INTO `sys_user_online` VALUES ('b4b252b6-637c-4aad-84dd-3162715c98b1', 'admin', '超级管理员', '0001', '0001', 0, '', 'XX部门', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-22 14:27:30', '2021-05-22 14:31:50', 604800000);
INSERT INTO `sys_user_online` VALUES ('b85a36ab-3b5b-49b3-9f09-600092ddb5bd', 'ys2', '用户2', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2021-05-20 14:33:57', '2021-05-20 14:34:05', 604800000);
INSERT INTO `sys_user_online` VALUES ('b99fb702-296e-4373-a4d5-b4ff9300ddf2', 'ys1', '伊升', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2021-05-20 15:43:15', '2021-05-20 15:43:21', 604800000);
INSERT INTO `sys_user_online` VALUES ('cce53530-f714-4089-8a32-ae43fd44ff8a', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', 'XX部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-05-18 20:44:55', '2021-05-18 22:01:31', 604800000);
INSERT INTO `sys_user_online` VALUES ('e1ead987-44e4-4b82-8fc5-00a316ba71d8', 'ys3', '用户3', NULL, NULL, 1, '', '内部', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-05-19 21:45:40', '2021-05-19 21:46:45', 604800000);
INSERT INTO `sys_user_online` VALUES ('ea7a3bbf-1c49-4f75-9d2d-56685106a5ad', 'ys1', '伊升', NULL, NULL, 0, '', '内部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2021-05-18 16:32:54', '2021-05-18 17:44:42', 604800000);
INSERT INTO `sys_user_online` VALUES ('fdedefb4-8d96-461e-9adb-0bc05d782a75', 'admin', '超级管理员', '0001', '0001', 0, '', 'XX部门', '10.1.1.38', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-05-21 22:13:32', '2021-05-21 22:13:32', 604800000);
...
INSERT INTO `sys_user_role` VALUES (12711, 116);
INSERT INTO `sys_user_role` VALUES (12714, 116);
INSERT INTO `sys_user_role` VALUES (12715, 116);
INSERT INTO `sys_user_role` VALUES (12716, 116);
...
CREATE TABLE `task`  (
  ...
  `yxj` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `end_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `finish_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of task
-- ----------------------------
INSERT INTO `task` VALUES (18, '需求分析', '任务APP产品的需求分析', 4, '紧急', '2021-05-31 00:00:00', '2021-05-21 22:49:16', 1, 9, 11, 12711);
INSERT INTO `task` VALUES (19, '总体设计文档', '完成总体设计文档', 5, '重要', '2021-05-31 00:00:00', NULL, 0, 10, 11, 12711);
INSERT INTO `task` VALUES (20, '产品计划书第一部分', '', 5, '重要', '2021-05-31 23:59:59', NULL, 0, 14, 12, 12711);
...
-- ----------------------------
INSERT INTO `task_file` VALUES (9, 18, '需求分析文件.txt', '/profile/upload/2021/05/21/41e540087508a9a89cc1f157742cc17c.txt');
INSERT INTO `task_file` VALUES (10, 20, '1621611626540.jpg', '/profile/upload/2021/05/21/7a78f93da89f235aac19bffaf65dcb4e.jpg');
...
-- ----------------------------
INSERT INTO `task_label` VALUES (4, '需求');
INSERT INTO `task_label` VALUES (5, '计划');
INSERT INTO `task_label` VALUES (6, '任务');
INSERT INTO `task_label` VALUES (7, '风险');
...
-- ----------------------------
INSERT INTO `task_message` VALUES (8, '加紧时间完成', '2021-05-21 22:48:21', 12711, 18);
INSERT INTO `task_message` VALUES (9, '这个计划书做的比较不错', '2021-05-21 22:49:11', 12711, 18);
INSERT INTO `task_message` VALUES (10, '好好干', '2021-05-21 23:31:44', 12711, 19);
INSERT INTO `task_message` VALUES (11, 'good', '2021-05-21 23:33:57', 12711, 18);
INSERT INTO `task_message` VALUES (12, '不错', '2021-05-21 23:41:06', 12711, 20);
...
CREATE TABLE `task_project`  (
  ...
  `duty_id` bigint(20) NULL DEFAULT NULL COMMENT '负责人ID',
  `status` int(255) NULL DEFAULT 0 COMMENT '状态0正常 1回收站',
  `temp_id` bigint(20) NULL DEFAULT NULL COMMENT '使用的模板ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of task_project
-- ----------------------------
INSERT INTO `task_project` VALUES (11, '任务管理APP产品研发', '', 12711, 0, 5);
INSERT INTO `task_project` VALUES (12, '任务管理APP产品发布', '', 12711, 0, 6);
INSERT INTO `task_project` VALUES (14, '测试项目', '简介的内容', 12711, 0, 6);

-- ----------------------------
-- Table structure for task_project_temp
-- ----------------------------
DROP TABLE IF EXISTS `task_project_temp`;
CREATE TABLE `task_project_temp`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '模版ID',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目模板' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of task_project_temp
-- ----------------------------
INSERT INTO `task_project_temp` VALUES (5, '软件生命周期', 100, '软件生命周期');
INSERT INTO `task_project_temp` VALUES (6, '产品发布', 90, '');

-- ----------------------------
-- Table structure for task_project_user
-- ----------------------------
DROP TABLE IF EXISTS `task_project_user`;
CREATE TABLE `task_project_user`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NULL DEFAULT NULL,
  `project_id` bigint(20) NULL DEFAULT NULL,
  `status` tinyint(4) NULL DEFAULT 0,
...
-- ----------------------------
-- Records of task_project_user
-- ----------------------------
INSERT INTO `task_project_user` VALUES (9, 12711, 11, 1);
INSERT INTO `task_project_user` VALUES (10, 12714, 11, 1);
INSERT INTO `task_project_user` VALUES (11, 12711, 12, 1);
INSERT INTO `task_project_user` VALUES (12, 12714, 12, 0);
INSERT INTO `task_project_user` VALUES (14, 12715, 11, 0);
INSERT INTO `task_project_user` VALUES (15, 12711, 14, 1);

-- ----------------------------
-- Table structure for task_temp_step
-- ----------------------------
DROP TABLE IF EXISTS `task_temp_step`;
CREATE TABLE `task_temp_step`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '步骤主键ID',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '步骤名称',
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序，大到小',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '说明',
  `temp_id` bigint(20) NULL DEFAULT NULL COMMENT '模板ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '步骤' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of task_temp_step
-- ----------------------------
INSERT INTO `task_temp_step` VALUES (9, '需求分析', 100, '', 5);
INSERT INTO `task_temp_step` VALUES (10, '总体设计', 90, '', 5);
INSERT INTO `task_temp_step` VALUES (11, '详细计划', 80, '', 5);
INSERT INTO `task_temp_step` VALUES (12, '编码及测试', 70, '', 5);
INSERT INTO `task_temp_step` VALUES (13, '实施和维护', 60, '', 5);
INSERT INTO `task_temp_step` VALUES (14, '产品计划', 100, '', 6);
INSERT INTO `task_temp_step` VALUES (15, '即将发布', 90, '', 6);
INSERT INTO `task_temp_step` VALUES (16, '测试', 80, '', 6);
INSERT INTO `task_temp_step` VALUES (17, '准备发布', 70, '', 6);
INSERT INTO `task_temp_step` VALUES (18, '发布成功', 60, '', 6);
