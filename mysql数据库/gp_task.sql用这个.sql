...
INSERT INTO `sys_config` VALUES (103, 'LOGO图片', 'sys.logo', '/profile/logo/2021/09/25/a3d771add9ab4ee8a6cd19562e6773af.jpg', 'Y', 'admin', '2019-08-08 00:03:03', 'admin', '2021-09-25 13:53:29', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (118, '移动端登录背景', 'app_login_bg', '/profile/logo/2021/09/25/e6f8f233c7f0913d184cbd7f83fd9f81.jpg', 'Y', 'admin', '2021-05-21 21:48:11', 'admin', '2021-09-25 16:45:17', NULL, 0, NULL, NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 1940 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_logininfor` VALUES (1935, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2021-09-25 13:49:56');
INSERT INTO `sys_logininfor` VALUES (1936, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-09-25 13:50:00');
INSERT INTO `sys_logininfor` VALUES (1937, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2021-09-25 14:35:55');
INSERT INTO `sys_logininfor` VALUES (1938, 'ys1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-09-25 14:35:59');
INSERT INTO `sys_logininfor` VALUES (1939, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-09-25 16:43:50');
...
) ENGINE = MyISAM AUTO_INCREMENT = 304 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_oper_log` VALUES (301, '参数管理', 2, 'com.study.web.controller.system.SysConfigController.updateAvatar()', 1, 'admin', 1, 0, 'XX部门', '/gp/system/config/uploadLogo', '127.0.0.1', NULL, '{\r\n  \"configId\" : [ \"103\" ],\r\n  \"configName\" : [ \"LOGO图片\" ],\r\n  \"configKey\" : [ \"sys.logo\" ],\r\n  \"configValue\" : [ \"/profile/logo/2021/05/22/80cd7cb527db8096d1e2f033f6f63719.png\" ]\r\n}', 0, NULL, '2021-09-25 13:53:28', '2021-09-25');
INSERT INTO `sys_oper_log` VALUES (302, '参数管理', 2, 'com.study.web.controller.system.SysConfigController.editSave()', 1, 'admin', 1, 0, 'XX部门', '/gp/system/config/edit', '127.0.0.1', NULL, '{\r\n  \"configId\" : [ \"103\" ],\r\n  \"configName\" : [ \"LOGO图片\" ],\r\n  \"configKey\" : [ \"sys.logo\" ],\r\n  \"configValue\" : [ \"/profile/logo/2021/09/25/a3d771add9ab4ee8a6cd19562e6773af.jpg\" ]\r\n}', 0, NULL, '2021-09-25 13:53:30', '2021-09-25');
INSERT INTO `sys_oper_log` VALUES (303, '个人信息', 2, 'com.study.web.controller.system.SysProfileController.updateAvatar()', 1, 'admin', 1, 0, 'XX部门', '/gp/system/user/profile/updateAvatar', '127.0.0.1', NULL, '{ }', 0, NULL, '2021-09-25 13:54:54', '2021-09-25');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12716 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '超级管理员', '0001', '0001', '', '', '1', '/profile/avatar/2021/09/25/7911837a878a770e817a86cf816458d3.png', '074f702fddb7679c5390d5edb1456dca', 'c085a6', '0', 0, '', '2021-04-21 23:43:50', '127.0.0.1', '2021-09-25 16:43:51', '管理员', 'admin', '2021-05-01 23:23:12', 'admin', '2021-09-25 16:43:50', NULL, NULL, 0, 'yZtq77VQjcHPOkQk8IxJzg==');
INSERT INTO `sys_user` VALUES (12711, 213, 'ys1', '伊升', NULL, NULL, '13454545rr@qq.com', '13865454545', '2', '', '09af46f284638c2fddf4cb0653f76f1e', '03cda6', '0', 0, NULL, '2021-05-01 23:23:12', '127.0.0.1', '2021-09-25 14:35:59', '', 'admin', '2021-05-01 23:23:12', 'admin', '2021-09-25 14:35:59', NULL, NULL, 0, 'LQVts40KUDWknT7lbhYLIjZowy9vL3Y62MKr5UiIGHFiDrIGx0X4qkmKzrBcfuNR');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('bdd6ce48-19e4-42d5-a4a5-79bf88a28f69', 'admin', '超级管理员', '0001', '0001', 0, '', 'XX部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2021-09-25 16:43:46', '2021-09-25 16:43:51', 604800000);
